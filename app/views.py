...
class serverStatus(APIView):
    def get(self, request):
        return Response(
            {"info": "Welcome to Dowell-Job-Portal-Version2.0"},
...
class get_job(APIView):
    def post(self, request):
        ...
        if data:
            ...
            if response:
                return Response(
                    {"message": "Job details.", "response": json.loads(response)},
                    status=status.HTTP_200_OK,
                )
            else:
                return Response(
...
class update_jobs(APIView):
    def post(self, request):
        ...
        if data:
            ...
            if response:
                return Response(
                    {"message": "Job updation successful."}, status=status.HTTP_200_OK
                )
            else:
                return Response(
...
class get_all_question(APIView):
    def get(self, request, company_id):
        ...
        return Response(
            {"error": "No question found"}, status=status.HTTP_304_NOT_MODIFIED
        )
...
class update_response(APIView):
    def patch(self, request):
        ...
        if insert_to_response or update_to_hr:
            ...
            return Response(
                {"message": "HR operation failed"}, status=status.HTTP_304_NOT_MODIFIED
            )
...
class get_response(APIView):
    def get(self, request):
        ...
        if response:
            ...
            return Response(
                {"error": "data not found"}, status=status.HTTP_304_NOT_MODIFIED
            )
