    ...
    const handleClick = async (ref, disableOtherBtns, action) => {
        ...
        switch (action) {
            case accountPageActions.MOVE_TO_ONBOARDING:
                ...
                await updateCandidateApplication(selectedCandidateData.id, { applicant: selectedCandidateData.applicant, status: candidateStatuses.ONBOARDING, job: selectedCandidateData.job, [mutableNewApplicationStateNames.freelancePlatform]: candidatePlatform })
            ...
            case accountPageActions.MOVE_TO_REHIRE:
                ...
                await updateCandidateApplication(selectedCandidateData.id, { applicant: selectedCandidateData.applicant, status: candidateStatuses.TO_REHIRE, job: selectedCandidateData.job })
            ...
            case accountPageActions.MOVE_TO_REJECTED:
                ...
                await updateCandidateApplication(selectedCandidateData.id, { applicant: selectedCandidateData.applicant, status: candidateStatuses.REJECTED, job: selectedCandidateData.job })
            ...
            case teamLeadActions.MOVE_TO_HIRED:
                ...
                await updateCandidateApplication(selectedCandidateData.id, { applicant: selectedCandidateData.applicant, status: candidateStatuses.TEAMLEAD_HIRE, job: selectedCandidateData.job, others: { ...selectedCandidateData.others,  [mutableNewApplicationStateNames.others_team_lead_remarks] : remarks } })
            ...
            case teamLeadActions.MOVE_TO_REHIRE:
                ...
                await updateCandidateApplication(selectedCandidateData.id, { applicant: selectedCandidateData.applicant, status: candidateStatuses.TEAMLEAD_TOREHIRE, job: selectedCandidateData.job })
            ...
            case hrPageActions.MOVE_TO_SELECTED:
                ...
                updateCandidateData(prevCandidates => { return prevCandidates.filter(candidate => candidate["_id"] !== selectedCandidateData["_id"]) })
