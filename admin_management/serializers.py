...
class AdminSerializer(serializers.Serializer):
    ...
    technical_specification = serializers.ListField(required=True, allow_empty=False)
    workflow_terms = serializers.ListField(required=True, allow_empty=False)
    payment_terms = serializers.ListField(required=True, allow_empty=False)
