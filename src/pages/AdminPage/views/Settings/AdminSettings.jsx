        ...
        <>
          ...
          <div className="Slections">
            ...
            <div>
              <label>
                <p>
                  Select User Portfolio <span>* </span> :
                </p>
                <select
                ...
                >
                  ...
                  {options1?.map((option) => (
                    <option key={option.org_id} value={option.portfolio_name}>
                      {option.portfolio_name}
                    </option>
                  ))}
                </select>
              </label>
              {userstatus?.length > 0 && firstSelection.length > 0 && (
                <p style={{ marginTop: "4%" }}>
                  Current application status:{userstatus}
                </p>
              )}
            </div>
            <div>
            ...
            <div>
              {secondSelection === "Proj_Lead" && firstSelection.length > 0 && (
                <label>
                  ...
                  <select
                    value={Proj_Lead}
                    onChange={(e) => setProj_Lead(e.target.value)}
                  >
                    <option disabled value="">
                      select a project
                    </option>
            ...
            {firstSelection && secondSelection && (
              <button
                onClick={
                  firstSelection && secondSelection !== "Proj_Lead"
                    ? submit
                    : submit2
                }
